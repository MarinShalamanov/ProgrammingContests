...
/**
 * In this code we have a very large array called arr, and very large 
 * set of operations
 ...
 * 
 * From: http://se7so.blogspot.bg/2012/12/segment-trees-and-lazy-propagation.html
 */
public class SegmentTreeLazy {
	...
	public SegmentTreeLazy(int _arr[]) {
		N = _arr.length;
	 ...
	 */
	void update_tree(int i, int j, int value) {
